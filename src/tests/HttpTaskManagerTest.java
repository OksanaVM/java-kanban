...
class HttpTaskManagerTest extends FileBackedTaskManagerTest {
    ...
    void testSaveAndLoad() {
        try {
            ...
            Iterator<Task> iter = history.iterator();
            assertEquals(task1.getId(), iter.next().getId(), "Неверный порядок задач в истории");
            assertEquals(task2.getId(), iter.next().getId(), "Неверный порядок задач в истории");
            assertEquals(epic1.getId(), iter.next().getId(), "Неверный порядок задач в истории");
            assertEquals(epic2.getId(), iter.next().getId(), "Неверный порядок задач в истории");
            assertEquals(sub1.getId(), iter.next().getId(), "Неверный порядок задач в истории");
            assertEquals(sub2.getId(), iter.next().getId(), "Неверный порядок задач в истории");
